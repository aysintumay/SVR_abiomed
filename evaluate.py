...
def get_svr(args):
    ...
    t = args.max_timesteps
    t0 = "07-31_18-02-13"
    filepath = os.path.join(args.save_path, "SVR_kde", save_path, f"svr_kde_seed_{args.seed}_{t0}_{t}.pth")
    # filepath ="/abiomed/models/policy_models/SVR/abiomed/svr_seed_1_2025-07-31_22-45-59_99999.pth"
    # svr_seed_1_2025-07-31_22-45-59_99999.pth
    # filepath ="/abiomed/models/policy_models/SVR_kde/abiomed/svr_kde_seed_1_2025-08-01_09-03-42_130000.pth"
    
    # filepath = "/abiomed/models/policy_models/SVR_bcmodels/bcmodel_abiomed.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/abiomed/intermediate_data_d4rl/farama_tqc_expert/HalfCheetah-v2_expert_1086.pkl")
